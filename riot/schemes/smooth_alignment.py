...
from riot.data.scheme_definitions import get_indels_positions
from riot.data.scheme_regions import get_cdr_ranges
from riot.schemes.collapse_alignment import collapse_ins_del
